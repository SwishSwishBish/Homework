...
import com.sena.hw02.AdventureGame.arsenal.armor.*;
import com.sena.hw02.AdventureGame.arsenal.weapon.*;
import com.sena.hw02.AdventureGame.location.Location;
import com.sena.hw02.AdventureGame.obstacle.Obstacle;
...
public abstract class CombatLocation extends Location {
    ...
    public CombatLocation(Player player, String name, Obstacle monster, String prize) {
        super(player);
        ...
        for (int i = 1; i <= this.getMonsterCount(); i++) {
            ...
            while (this.getPlayer().getHealth() > 0 && this.getMonster().getHealth() > 0) {
                System.out.println("Hit or Run " + "\n" +
                        "H --> Hit " + "\n" +
                        "R --> Run ");
                String userChoice = Location.scanner.nextLine();
